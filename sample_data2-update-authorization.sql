...
-- (AccountTransaction)
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (4, 547864.00, 'payment', 'FAILED', '2023-07-18 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (3, 448774.00, 'withdraw', 'PENDING', '2023-12-21 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (12, 931723.00, 'withdraw', 'PENDING', '2025-10-07 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (19, 650403.00, 'withdraw', 'PENDING', '2023-09-24 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (9, 962218.00, 'deposit', 'COMPLETED', '2025-03-03 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (13, 110479.00, 'payment', 'FAILED', '2023-09-11 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (19, 899527.00, 'deposit', 'PENDING', '2023-03-26 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (1, 759356.00, 'deposit', 'FAILED', '2025-08-02 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (10, 498544.00, 'deposit', 'FAILED', '2024-05-07 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (20, 649159.00, 'payment', 'COMPLETED', '2024-10-11 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (6, 150406.00, 'payment', 'FAILED', '2025-03-15 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (2, 836450.00, 'withdraw', 'COMPLETED', '2025-04-27 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (12, 856602.00, 'payment', 'COMPLETED', '2025-03-30 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (18, 762333.00, 'deposit', 'PENDING', '2023-11-27 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (1, 785287.00, 'withdraw', 'PENDING', '2025-07-20 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (18, 246612.00, 'payment', 'PENDING', '2024-03-08 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (16, 789589.00, 'payment', 'PENDING', '2023-06-25 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (7, 675661.00, 'withdraw', 'PENDING', '2025-02-17 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (8, 734688.00, 'withdraw', 'PENDING', '2023-08-29 09:22:31');
INSERT INTO AccountTransaction (user_id, amount, type, status, created_at) VALUES (13, 466972.00, 'deposit', 'COMPLETED', '2024-04-25 09:22:31');
...
-- (Permission)
-- ============================================
-- MODULE: AUCTION (10 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Create Auction', '/api/auctions', 'POST', 'AUCTION', 'Tạo phiên đấu giá mới'),
('Get Auctions', '/api/auctions', 'GET', 'AUCTION', 'Lấy danh sách phiên đấu giá'),
('Get Auction By Id', '/api/auctions/{id}', 'GET', 'AUCTION', 'Lấy thông tin chi tiết phiên đấu giá'),
('Update Auction', '/api/auctions/{id}', 'PUT', 'AUCTION', 'Cập nhật phiên đấu giá'),
('Delete Auction', '/api/auctions/{id}', 'DELETE', 'AUCTION', 'Xóa phiên đấu giá'),
('Start Auction', '/api/auctions/{auctionId}/start', 'POST', 'AUCTION', 'Bắt đầu phiên đấu giá thủ công'),
('Close Auction', '/api/auctions/{auctionId}/close', 'POST', 'AUCTION', 'Đóng phiên đấu giá thủ công'),
('Approve Auction', '/api/auctions/{auctionId}/approve', 'PUT', 'AUCTION', 'Admin duyệt phiên đấu giá'),
('Get My Auctions', '/api/auctions/me', 'GET', 'AUCTION', 'Lấy danh sách phiên đấu giá của seller hiện tại'),
('Get Auctions By Seller', '/api/auctions/seller/{sellerId}', 'GET', 'AUCTION', 'Lấy danh sách phiên đấu giá của seller theo ID');
-- ============================================
-- MODULE: BID (5 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Place Bid', '/api/bids', 'POST', 'BID', 'Đặt giá thầu thủ công'),
('Place Auto Bid', '/api/bids/auto', 'POST', 'BID', 'Đặt giá thầu tự động'),
('Get Bids By Auction', '/api/bids/auction/{auctionId}', 'GET', 'BID', 'Lấy danh sách giá thầu theo phiên đấu giá'),
('Get Highest Bid', '/api/bids/auction/{auctionId}/highest', 'GET', 'BID', 'Lấy giá thầu cao nhất của phiên đấu giá'),
('Get Bids By User', '/api/bids/user/{userId}', 'GET', 'BID', 'Lấy danh sách giá thầu theo người dùng');
-- ============================================
-- MODULE: UPLOAD (2 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Upload Single Image', '/api/upload', 'POST', 'UPLOAD', 'Upload một ảnh'),
('Upload Multiple Images', '/api/upload/multiple', 'POST', 'UPLOAD', 'Upload nhiều ảnh');
-- ============================================
-- MODULE: AUTH (4 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Register', '/api/auth/register', 'POST', 'AUTH', 'Đăng ký tài khoản'),
('Login', '/api/auth/login', 'POST', 'AUTH', 'Đăng nhập'),
('Verify Email', '/api/auth/verify', 'GET', 'AUTH', 'Xác thực email'),
('Resend Verification', '/api/auth/resend-verification', 'POST', 'AUTH', 'Gửi lại email xác thực');
-- ============================================
-- MODULE: PERMISSION (5 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Create Permission', '/api/permissions', 'POST', 'PERMISSION', 'Tạo permission mới'),
('List Permissions', '/api/permissions', 'GET', 'PERMISSION', 'Lấy danh sách permissions'),
('Get Permission By Id', '/api/permissions/{id}', 'GET', 'PERMISSION', 'Lấy thông tin permission theo ID'),
('Update Permission', '/api/permissions/{id}', 'PATCH', 'PERMISSION', 'Cập nhật permission'),
('Delete Permission', '/api/permissions/{id}', 'DELETE', 'PERMISSION', 'Xóa permission');
-- ============================================
-- MODULE: ROLE (5 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Create Role', '/api/roles', 'POST', 'ROLE', 'Tạo role mới'),
('List Roles', '/api/roles', 'GET', 'ROLE', 'Lấy danh sách roles'),
('Get Role By Id', '/api/roles/{id}', 'GET', 'ROLE', 'Lấy thông tin role theo ID'),
('Update Role', '/api/roles/{id}', 'PATCH', 'ROLE', 'Cập nhật role'),
('Delete Role', '/api/roles/{id}', 'DELETE', 'ROLE', 'Xóa role');
-- ============================================
-- MODULE: NOTIFICATION (8 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Get Notifications', '/api/notifications', 'GET', 'NOTIFICATION', 'Lấy danh sách thông báo của user hiện tại'),
('Get Notifications By User', '/api/notifications/user/{userId}', 'GET', 'NOTIFICATION', 'Lấy danh sách thông báo theo userId'),
('Mark Notification As Read', '/api/notifications/{id}/read', 'PUT', 'NOTIFICATION', 'Đánh dấu thông báo đã đọc'),
('Mark Notification As Read Patch', '/api/notifications/{id}/read', 'PATCH', 'NOTIFICATION', 'Đánh dấu thông báo đã đọc (PATCH)'),
('Mark All Notifications As Read', '/api/notifications/user/{userId}/read-all', 'PUT', 'NOTIFICATION', 'Đánh dấu tất cả thông báo đã đọc'),
('Mark All Notifications As Read Patch', '/api/notifications/user/{userId}/read-all', 'PATCH', 'NOTIFICATION', 'Đánh dấu tất cả thông báo đã đọc (PATCH)'),
('Mark Notifications By Type As Read', '/api/notifications/read-by-type', 'PATCH', 'NOTIFICATION', 'Đánh dấu thông báo đã đọc theo loại'),
('Get Unread Count', '/api/notifications/unread-count', 'GET', 'NOTIFICATION', 'Lấy số lượng thông báo chưa đọc'),
('Delete Notification', '/api/notifications/{id}', 'DELETE', 'NOTIFICATION', 'Xóa thông báo');
-- ============================================
-- MODULE: WARNING (5 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Create Warning', '/api/warnings', 'POST', 'WARNING', 'Tạo cảnh báo mới'),
('Get All Warnings', '/api/warnings', 'GET', 'WARNING', 'Lấy danh sách tất cả cảnh báo'),
('Get Warnings By User', '/api/warnings/user/{userId}', 'GET', 'WARNING', 'Lấy danh sách cảnh báo theo user'),
('Get Warnings By Transaction', '/api/warnings/transaction/{txnId}', 'GET', 'WARNING', 'Lấy danh sách cảnh báo theo giao dịch'),
('Auto Warn Pending Transactions', '/api/warnings/auto-warn', 'POST', 'WARNING', 'Tự động tạo cảnh báo cho giao dịch quá hạn');
-- ============================================
-- MODULE: PRODUCT (10 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Create Product', '/api/products', 'POST', 'PRODUCT', 'Tạo sản phẩm mới'),
('Update Product', '/api/products/{id}', 'PUT', 'PRODUCT', 'Cập nhật sản phẩm'),
('Get Product By Id', '/api/products/{id}', 'GET', 'PRODUCT', 'Lấy thông tin sản phẩm theo ID'),
('Delete Product', '/api/products/{id}', 'DELETE', 'PRODUCT', 'Xóa sản phẩm'),
('Get Products Page', '/api/products/page', 'GET', 'PRODUCT', 'Lấy danh sách sản phẩm phân trang'),
('Get Products By Seller Page', '/api/products/seller/{sellerId}/page', 'GET', 'PRODUCT', 'Lấy danh sách sản phẩm của seller phân trang'),
('Get My Products Page', '/api/products/seller/me/page', 'GET', 'PRODUCT', 'Lấy danh sách sản phẩm của seller hiện tại'),
('Approve Product', '/api/products/{id}/approve', 'PUT', 'PRODUCT', 'Admin duyệt sản phẩm'),
('Request Product Approval', '/api/products/{id}/approval-request', 'POST', 'PRODUCT', 'Seller gửi yêu cầu duyệt sản phẩm');
-- ============================================
-- MODULE: ACCOUNT TRANSACTION (5 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Deposit', '/api/account/deposit', 'POST', 'ACCOUNT', 'Nạp tiền vào tài khoản'),
('Withdraw', '/api/account/withdraw', 'POST', 'ACCOUNT', 'Rút tiền khỏi tài khoản'),
('Confirm Withdraw', '/api/account/withdraw/confirm/{id}', 'POST', 'ACCOUNT', 'Xác nhận rút tiền'),
('Get Transactions By User', '/api/account/user/{userId}', 'GET', 'ACCOUNT', 'Lấy lịch sử giao dịch tài khoản theo user'),
('Get Withdrawable Amount', '/api/account/user/{userId}/withdrawable', 'GET', 'ACCOUNT', 'Lấy số tiền có thể rút');
-- ============================================
-- MODULE: TRANSACTION AFTER AUCTION (8 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Pay Transaction', '/api/transactions/after-auction/{txnId}/pay', 'POST', 'TRANSACTION', 'Thanh toán giao dịch'),
('Update Transaction Status', '/api/transactions/after-auction/{txnId}/status', 'PUT', 'TRANSACTION', 'Cập nhật trạng thái giao dịch'),
('Cancel Transaction', '/api/transactions/after-auction/{txnId}/cancel', 'PUT', 'TRANSACTION', 'Hủy giao dịch'),
('Get Transactions By User', '/api/transactions/after-auction/user/{userId}', 'GET', 'TRANSACTION', 'Lấy danh sách giao dịch theo user'),
('Get Transactions By Seller', '/api/transactions/after-auction/seller/{sellerId}', 'GET', 'TRANSACTION', 'Lấy danh sách giao dịch theo seller'),
('Get Transaction By Auction', '/api/transactions/after-auction/auction/{auctionId}', 'GET', 'TRANSACTION', 'Lấy giao dịch theo phiên đấu giá'),
('Get Won Products', '/api/transactions/after-auction/{userId}/won-products', 'GET', 'TRANSACTION', 'Lấy danh sách sản phẩm đã thắng');
-- ============================================
-- MODULE: ADMIN USER (8 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Get All Users', '/api/superadmin/users', 'GET', 'ADMIN', 'Lấy danh sách tất cả users'),
('Get User By Id', '/api/superadmin/users/{id}', 'GET', 'ADMIN', 'Lấy thông tin user theo ID'),
('Update User', '/api/superadmin/users/{id}', 'PUT', 'ADMIN', 'Admin cập nhật thông tin user'),
('Ban User', '/api/superadmin/users/{id}/ban', 'PUT', 'ADMIN', 'Khóa tài khoản user'),
('Unban User', '/api/superadmin/users/{id}/unban', 'PUT', 'ADMIN', 'Mở khóa tài khoản user'),
('Delete User', '/api/superadmin/users/{id}', 'DELETE', 'ADMIN', 'Xóa vĩnh viễn user'),
('Soft Delete User', '/api/superadmin/users/{id}/soft-delete', 'PUT', 'ADMIN', 'Xóa mềm user'),
('Get User Transactions', '/api/superadmin/users/{id}/transactions', 'GET', 'ADMIN', 'Lấy lịch sử giao dịch của user');
-- ============================================
-- MODULE: USER (7 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Get Current User', '/api/users/me', 'GET', 'USER', 'Lấy thông tin user hiện tại'),
('Get User Public Profile', '/api/users/{id}', 'GET', 'USER', 'Lấy thông tin công khai của user'),
('Update Current User', '/api/users/me', 'PUT', 'USER', 'Cập nhật thông tin user hiện tại'),
('Change Password', '/api/users/change-password', 'PATCH', 'USER', 'Đổi mật khẩu'),
('Update Avatar', '/api/users/me/avatar', 'PUT', 'USER', 'Cập nhật avatar'),
('Get Participating Auctions', '/api/users/{userId}/auctions/participating', 'GET', 'USER', 'Lấy danh sách phiên đấu giá đang tham gia'),
('Upgrade To Seller', '/api/users/upgrade-to-seller', 'PUT', 'USER', 'Nâng cấp tài khoản lên Seller');
-- ============================================
-- MODULE: USER REPORT (3 APIs)
-- ============================================
INSERT INTO permission (permission_name, api_path, method, module, description) VALUES 
('Create User Report', '/api/user-reports', 'POST', 'USER_REPORT', 'Tạo báo cáo người dùng'),
('Get Reports By User', '/api/user-reports/user/{userId}', 'GET', 'USER_REPORT', 'Lấy danh sách báo cáo theo user'),
('Get All Reports', '/api/user-reports', 'GET', 'USER_REPORT', 'Lấy tất cả báo cáo');
-- (RolePermission)
-- ============================================
-- PERMISSION ID MAPPING (1-84)
-- ============================================
-- 1-10: AUCTION
-- 11-15: BID
-- 16-17: UPLOAD
-- 18-21: AUTH (public - không cần assign)
-- 22-26: PERMISSION (admin only)
-- 27-31: ROLE (admin only)
-- 32-40: NOTIFICATION
-- 41-45: WARNING (moderator/admin)
-- 46-54: PRODUCT
-- 55-59: ACCOUNT TRANSACTION
-- 60-66: TRANSACTION AFTER AUCTION
-- 67-74: ADMIN USER (admin only)
-- 75-81: USER
-- 82-84: USER REPORT
-- ====================================
-- BIDDER (role_id = 1)
-- Có thể: bid, xem auction, upload avatar, quản lý tài khoản, 
-- thanh toán khi thắng, quản lý profile, tạo report
-- KHÔNG thể: xem all reports list
-- ====================================
INSERT INTO rolePermission (role_id, permission_id) VALUES
-- Auction - xem danh sách và chi tiết (public)
(1, 2),   -- Get Auctions (GET /api/auctions)
(1, 3),   -- Get Auction By Id (GET /api/auctions/{id})
(1, 10),  -- Get Auctions By Seller (GET /api/auctions/seller/{sellerId})
-- Bids - đặt giá thầu
(1, 11),  -- Place Bid (POST /api/bids)
(1, 12),  -- Place Auto Bid (POST /api/bids/auto)
(1, 13),  -- Get Bids By Auction (GET /api/bids/auction/{auctionId})
(1, 14),  -- Get Highest Bid (GET /api/bids/auction/{auctionId}/highest)
(1, 15),  -- Get Bids By User (GET /api/bids/user/{userId})
-- Upload (để upload avatar)
(1, 16),  -- Upload Single Image (POST /api/upload)
(1, 17),  -- Upload Multiple Images (POST /api/upload/multiple)
-- Notification - quản lý thông báo
(1, 32),  -- Get Notifications (GET /api/notifications)
(1, 33),  -- Get Notifications By User (GET /api/notifications/user/{userId})
(1, 34),  -- Mark Notification As Read (PUT /api/notifications/{id}/read)
(1, 35),  -- Mark Notification As Read Patch (PATCH /api/notifications/{id}/read)
(1, 36),  -- Mark All Notifications As Read (PUT /api/notifications/user/{userId}/read-all)
(1, 37),  -- Mark All Notifications As Read Patch (PATCH /api/notifications/user/{userId}/read-all)
(1, 38),  -- Mark Notifications By Type As Read (PATCH /api/notifications/read-by-type)
(1, 39),  -- Get Unread Count (GET /api/notifications/unread-count)
(1, 40),  -- Delete Notification (DELETE /api/notifications/{id})
-- Product - chỉ xem (public)
(1, 48),  -- Get Product By Id (GET /api/products/{id})
(1, 50),  -- Get Products Page (GET /api/products/page)
(1, 51),  -- Get Products By Seller Page (GET /api/products/seller/{sellerId}/page)
-- Account Transactions - quản lý tiền của mình
(1, 55),  -- Deposit (POST /api/account/deposit)
(1, 56),  -- Withdraw (POST /api/account/withdraw)
(1, 57),  -- Confirm Withdraw (POST /api/account/withdraw/confirm/{id})
(1, 58),  -- Get Transactions By User (GET /api/account/user/{userId})
(1, 59),  -- Get Withdrawable Amount (GET /api/account/user/{userId}/withdrawable)
-- Transaction After Auction - thanh toán khi thắng
(1, 60),  -- Pay Transaction (POST /api/transactions/after-auction/{txnId}/pay)
(1, 61),  -- Update Transaction Status (XÁC NHẬN ĐÃ NHẬN HÀNG)
(1, 63),  -- Get Transactions By User (GET /api/transactions/after-auction/user/{userId})
(1, 66),  -- Get Won Products (GET /api/transactions/after-auction/{userId}/won-products)
-- User Profile - quản lý chính mình
(1, 75),  -- Get Current User (GET /api/users/me)
(1, 76),  -- Get User Public Profile (GET /api/users/{id})
(1, 77),  -- Update Current User (PUT /api/users/me)
(1, 78),  -- Change Password (PATCH /api/users/change-password)
(1, 79),  -- Update Avatar (PUT /api/users/me/avatar)
(1, 80),  -- Get Participating Auctions (GET /api/users/{userId}/auctions/participating)
(1, 81),  -- Upgrade To Seller (PUT /api/users/upgrade-to-seller)
-- User Reports - CHỈ tạo report, KHÔNG xem all list
(1, 82);  -- Create User Report (POST /api/user-reports)
-- ====================================
-- SELLER (role_id = 2)
...
-- ====================================
INSERT INTO rolePermission (role_id, permission_id) VALUES
-- Auction - xem + tạo/sửa/xóa của mình (KHÔNG duyệt)
(2, 1),   -- Create Auction (POST /api/auctions)
(2, 2),   -- Get Auctions (GET /api/auctions)
(2, 3),   -- Get Auction By Id (GET /api/auctions/{id})
(2, 4),   -- Update Auction (PUT /api/auctions/{id})
(2, 5),   -- Delete Auction (DELETE /api/auctions/{id})
(2, 9),   -- Get My Auctions (GET /api/auctions/me)
(2, 10),  -- Get Auctions By Seller (GET /api/auctions/seller/{sellerId})
-- Bids - SELLER cũng có thể bid
(2, 11),  -- Place Bid (POST /api/bids)
(2, 12),  -- Place Auto Bid (POST /api/bids/auto)
(2, 13),  -- Get Bids By Auction (GET /api/bids/auction/{auctionId})
(2, 14),  -- Get Highest Bid (GET /api/bids/auction/{auctionId}/highest)
(2, 15),  -- Get Bids By User (GET /api/bids/user/{userId})
-- Upload
(2, 16),  -- Upload Single Image (POST /api/upload)
(2, 17),  -- Upload Multiple Images (POST /api/upload/multiple)
-- Notification
(2, 32),  -- Get Notifications
(2, 33),  -- Get Notifications By User
(2, 34),  -- Mark Notification As Read
(2, 35),  -- Mark Notification As Read Patch
(2, 36),  -- Mark All Notifications As Read
(2, 37),  -- Mark All Notifications As Read Patch
(2, 38),  -- Mark Notifications By Type As Read
(2, 39),  -- Get Unread Count
(2, 40),  -- Delete Notification
-- Products - SELLER tạo/sửa/xóa products của mình (KHÔNG duyệt)
(2, 46),  -- Create Product (POST /api/products)
(2, 47),  -- Update Product (PUT /api/products/{id})
(2, 48),  -- Get Product By Id (GET /api/products/{id})
(2, 49),  -- Delete Product (DELETE /api/products/{id})
(2, 50),  -- Get Products Page (GET /api/products/page)
(2, 51),  -- Get Products By Seller Page (GET /api/products/seller/{sellerId}/page)
(2, 52),  -- Get My Products Page (GET /api/products/seller/me/page)
(2, 54),  -- Request Product Approval (POST /api/products/{id}/approval-request)
-- Account Transactions
(2, 55),  -- Deposit
(2, 56),  -- Withdraw
(2, 57),  -- Confirm Withdraw
(2, 58),  -- Get Transactions By User
(2, 59),  -- Get Withdrawable Amount
-- Transaction After Auction - SELLER cập nhật trạng thái giao hàng
(2, 60),  -- Pay Transaction
(2, 61),  -- Update Transaction Status (PUT /api/transactions/after-auction/{txnId}/status)
(2, 62),  -- Cancel Transaction (PUT /api/transactions/after-auction/{txnId}/cancel)
(2, 63),  -- Get Transactions By User
(2, 64),  -- Get Transactions By Seller (GET /api/transactions/after-auction/seller/{sellerId})
(2, 65),  -- Get Transaction By Auction
(2, 66),  -- Get Won Products
-- User Profile
(2, 75),  -- Get Current User
(2, 76),  -- Get User Public Profile
(2, 77),  -- Update Current User
(2, 78),  -- Change Password
(2, 79),  -- Update Avatar
(2, 80),  -- Get Participating Auctions
(2, 81),  -- Upgrade To Seller
-- User Reports - CHỈ tạo report
(2, 82);  -- Create User Report
-- ====================================
-- ADMIN (role_id = 3)
-- TẤT CẢ QUYỀN
-- ====================================
...
-- ====================================
INSERT INTO rolePermission (role_id, permission_id) VALUES
-- Auction - MODERATOR duyệt, đóng, xóa auctions
(4, 2),   -- Get Auctions
(4, 3),   -- Get Auction By Id
(4, 5),   -- Delete Auction (xóa auction vi phạm)
(4, 7),   -- Close Auction (đóng auction lập tức)
(4, 8),   -- Approve Auction (duyệt yêu cầu tạo auction)
(4, 9),   -- Get My Auctions
(4, 10),  -- Get Auctions By Seller
-- Bids - xem để kiểm tra
(4, 13),  -- Get Bids By Auction
(4, 14),  -- Get Highest Bid
(4, 15),  -- Get Bids By User
-- Upload
(4, 16),  -- Upload Single Image
(4, 17),  -- Upload Multiple Images
-- Notification
(4, 32), (4, 33), (4, 34), (4, 35), (4, 36), (4, 37), (4, 38), (4, 39), (4, 40),
-- Warnings - quản lý cảnh báo user
(4, 41),  -- Create Warning
(4, 42),  -- Get All Warnings
(4, 43),  -- Get Warnings By User
(4, 44),  -- Get Warnings By Transaction
(4, 45),  -- Auto Warn Pending Transactions
-- Products - MODERATOR duyệt, xóa products
(4, 48),  -- Get Product By Id
(4, 49),  -- Delete Product (xóa product vi phạm)
(4, 50),  -- Get Products Page
(4, 51),  -- Get Products By Seller Page
(4, 53),  -- Approve Product (duyệt product)
-- Transaction - xem để xử lý tranh chấp
(4, 61),  -- Update Transaction Status
(4, 62),  -- Cancel Transaction
(4, 63),  -- Get Transactions By User
(4, 64),  -- Get Transactions By Seller
(4, 65),  -- Get Transaction By Auction
-- User Profile (self only)
(4, 75),  -- Get Current User
(4, 76),  -- Get User Public Profile
(4, 77),  -- Update Current User
(4, 78),  -- Change Password
(4, 79),  -- Update Avatar
-- User Reports - xem ALL reports từ users
(4, 82),  -- Create User Report
(4, 83),  -- Get Reports By User

(4, 84);  -- Get All Reports
